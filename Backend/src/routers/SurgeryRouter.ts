...
class SurgeryRouter{
    ...
    constructor(surgeryController:SurgeryController){
        ...
        router.put('/:SurgeryId/report', isAuthorizated,surgeryController.updateSurgeryReport);
        router.delete('/:SurgeryId', isAuthorizated,surgeryController.deleteSurgery);
